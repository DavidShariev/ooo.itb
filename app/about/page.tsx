          ...
          <div className=" lg:flex">
            ...
            <div className="w-full">
              ...
              <p className="mb-8 text-base  !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-lg">
                Год основания: октябрь 2009. Основными направлениями
                деятельности компании являются: Проектирование, внедрение и
                сопровождение систем защиты информации, Сертификация средств
                защиты и встроенных механизмов защиты в прикладное ПО, ОС, СУБД,
                Аттестационные испытания ГИС, ИСПДн, АС. Компания является
                разработчиком и производителем системы мониторинга и корреляции
                событий информационной безопасности Security Capsule SIEM,
                операционной системы OS EMIAS 1.0.
              </p>
              <h2 className="mb-8 text-xl font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight">
                ...
                <ul className="mt-5 text-base font-normal !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-lg">
                  <li className="mb-4">
                    ...
                    основе использования широкого спектра представленных
                    средств;
                  </li>
                  <li className="mb-4">
              ...
              <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-lg">
                Коллектив сотрудников объединяет четкое понимание целей компании
                и путей их достижения. Использование передовых технологий,
                строгое исполнение взятых на себя обязательств и качественное
                воплощение проектов позволяет компании завоевать доверие
                партнеров и получить конкурентные преимущества.
              </p>
              ...
              <div className="wrap flex items-center gap-10">
                ...
                <div className="flex-1">
                  <p className="text-base !leading-relaxed text-body-color  dark:opacity-90 sm:text-lg md:text-lg">
                    ...
                    высококвалифицированных сотрудников. РУССОФТ представляет
                    всю индустрию разработки ПО в России. Центральный офис
                    Партнерства находится в Санкт-Петербурге.
                  </p>
                </div>
              </div>
            </div>
