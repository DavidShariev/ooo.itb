const NewsLatterBox = () => {
  return (
    ...
    >
      ...
      <div className="mb-8 border-b border-body-color border-opacity-25 pb-8 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        <span className="text-black dark:text-white">Адрес юридический:</span>{" "}
        198097 г. Санкт-Петербург, проспект Стачек, д.48, кор. 2, оф. 202. БЦ
        «Империал»
      </div>
      <div className="mb-8 border-b border-body-color border-opacity-25 pb-8 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        <span className="text-black dark:text-white">Адрес почтовый:</span>{" "}
        198097, Санкт-Петербург,а\я 97
      </div>
      <div className="mb-8 border-b border-body-color border-opacity-25 pb-8 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        <span className="text-black dark:text-white">Электронная почта:</span>{" "}
        <div></div>
        1. По общим вопросам: manager@itb.spb.ru<div></div>
        2. Для партнеров: partners@itb.spb.ru<div></div>
        3. Техническая поддержка: upport@itb.spb.ru<div></div>
      </div>
      <div className="mb-8 border-b border-body-color border-opacity-25 pb-8 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
