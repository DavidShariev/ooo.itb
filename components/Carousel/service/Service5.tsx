...
import serviceImage5 from "@/public/images/services/services_5.png";
  ...
  return (
    ...
    >
      ...
      <div className="my-20">
        ...
        <ul>
          <p className="py-3">Основными заказчиками услуги по тестированию на проникновение (Pentest) выступали:</p>
      ...
      <div className="my-20">
        ...
        <ul>
          <p className="py-3">В состав работ по тестированию на проникновение (Pentest) может входить:</p>
        ...
        <p className="py-3">Возможны форматы оказания услуги как Black Box\Gray Box\White Box</p>
        <p className="py-3">Стоимость оказания услуги оценивается на основе данных предоставляемых Заказчиком в Опросном листе на предварительном этапе подготовке к оказанию услуги.</p>
      </div>
      ...
      <div className="my-20">
        ...
        <ul className="py-5">
          <p className="py-3">По результатам выполнения заданных проверок формируется сводный отчет в формате rtf, html или pdf. Экспертом Исполнителя проводится анализ обнаруженных уязвимостей\сценариев компрометации и степени их влияния на защищенность объекта обследования осуществляется экспертным методом. Формат описания уязвимостей включает:</p>
